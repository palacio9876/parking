...
const createVehicleDto = z.object({
  ...
  type: z.enum(['car', 'motorcycle', 'bicycle'], { message: 'type must be car, motorcycle, or bicycle' }),
...
const updateVehicleDto = z.object({
  ...
  type: z.enum(['car', 'motorcycle', 'bicycle'], { message: 'type must be car, motorcycle, or bicycle' }).optional(),
